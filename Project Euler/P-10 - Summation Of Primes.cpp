...
// helpful method to print out the sum of the elements of the input vector
ull getVectorSum(v_ull input_vector) {
	ull sum = 0;
...
int main() {
	...
	ull prime_limit = 2e+6;
	cout << "Sum of primes below 2 million : " << getVectorSum(listPrimes_SieveOfEratosthenes(prime_limit)) << endl;
